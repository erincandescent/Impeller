...
public class OpenGraph
{
    ...
    public final static String OG_NS = "http://ogp.me/ns#";
    public final static String TWITTER_NS = "tag:e43.eu,2013:ns-twitter:";
    ...
    */
    ...
    public OpenGraph(String url, boolean ignoreSpecErrors) throws java.io.IOException, Exception {
        ...
        siteConnection.setRequestProperty("User-Agent", "E43 Impeller");
        ...
        // Impeller: inject twitter "namespace" so we can scrape twitter cards
        pageNamespaces.add(new OpenGraphNamespace("twitter", TWITTER_NS));
		...
		if (!hasOGspec)
			pageNamespaces.add(new OpenGraphNamespace("og", OG_NS));
    ...
    {
        return getContent(OG_NS, property);
    }
     ...
     */
    public String getContent(String namespace, String property)
	{
        String uri = namespace + property;

        if (metaAttributes.containsKey(uri) && metaAttributes.get(uri).size() > 0)
			return metaAttributes.get(uri).get(0).getContent();
		else
			return null;
    }
    ...
    {
        return getProperties(OG_NS, property);
    }
     ...
     * @return An array of all currently defined properties
     */
    public MetaElement[] getProperties(String namespace, String property)
	{
		if (metaAttributes.containsKey(namespace + property))
		{
			ArrayList target = metaAttributes.get(namespace + property);
    ...
    public void setProperty(OpenGraphNamespace namespace, String property, String content)
	{
		...
		property = property.replaceAll(namespace.getPrefix() + ":", namespace.getSchemaURI());
